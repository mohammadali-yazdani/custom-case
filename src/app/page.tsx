        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 text-5xl font-bold tracking-tight text-gray-950 md:text-6xl">
                ...
                <span className="relative bg-lime-600 px-2 text-white">
                  your own case
                </span>{" "}
                now
              </h2>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex grid-cols-2 flex-col items-center gap-40 md:grid">
              <img
                className="absolute start-1/2 top-[25rem] z-10 -translate-x-1/2 -translate-y-1/2 rotate-90 md:top-1/2 md:rotate-0"
                src="/arrow.png"
                alt=""
              />

              <div className="relative h-80 max-w-sm rounded-xl bg-gray-950/5 ring-gray-950/10 ring-inset md:h-full md:justify-self-end lg:rounded-2xl">
                <img
                  className="size-full rounded-md bg-white object-cover shadow-2xl ring-1 ring-gray-950/10"
                  src="/horse.jpg"
                  alt="horse"
                />
              </div>
          ...
          <ul className="mx-auto mt-12 w-fit max-w-prose space-y-2 sm:text-lg">
            <li className="w-fit">
              <Check className="me-1.5 inline size-5 text-lime-600" />
            ...
            <li className="w-fit">
              <Check className="me-1.5 inline size-5 text-lime-600" />5 year
              print warranty
            </li>
            ...
            <div className="flex justify-center">
              ...
              >
                Create your case now <ArrowRight className="ms-1 size-4" />
              </Link>
            </div>
          </ul>
        </MaxWidthWrapper>
